          ...
          <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center"><img class="slide" src="/baixiu/static/uploads/slide_1.jpg"></td>
                <td>XIU功能演示</td>
                <td>#</td>
              ...
              <tr>
                <td class="text-center"><input type="checkbox"></td>
                <td class="text-center"><img class="slide" src="/baixiu/static/uploads/slide_2.jpg"></td>
                <td>XIU功能演示</td>
                <td>#</td>
                <td class="text-center">
                  <a href="javascript:;" class="btn btn-danger btn-xs">删除</a>
