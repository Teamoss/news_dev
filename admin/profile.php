    ...
    <div class="container-fluid">
      ...
      <form class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <label class="form-image">
              ...
              <img src="/baixiu/static/assets/img/default.png">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input id="email" class="form-control" name="email" type="type" value="xxxx@xxx" placeholder="邮箱" readonly>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input id="slug" class="form-control" name="slug" type="type" value="xxx" placeholder="slug">
            <p class="help-block">https://xxxx/author/<strong>xxx</strong></p>
          </div>
        </div>
        <div class="form-group">
          <label for="nickname" class="col-sm-3 control-label">昵称</label>
          <div class="col-sm-6">
            <input id="nickname" class="form-control" name="nickname" type="type" value="xx" placeholder="昵称">
